        ...
        <div className="relative z-10 flex flex-wrap items-start justify-between gap-4">
          <div className="max-w-5xl">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              {language === 'es'
                ? 'Desde la regla Write-Ahead Logging hasta el tamaño de los VLFs: aquí se ve por qué WRITELOG, crash recovery y autogrowth pequeño pueden cambiar por completo el comportamiento de una base.'
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h3 className="mt-2 text-2xl font-bold text-white">
                {language === 'es'
                  ? 'El commit no ocurre hasta que el log está endurecido'
      ...
      <div className="glass-panel rounded-3xl border border-white/10 p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="max-w-4xl">
            ...
            <h3 className="mt-2 text-2xl font-bold text-white">
              {language === 'es'
                ? 'Un log sano recupera rápido; un log fragmentado obliga a escanear cientos de VLFs'
