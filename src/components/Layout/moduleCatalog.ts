...
export const SURFACE_DEFINITIONS: Record<SurfaceId, SurfaceDefinition> = {
  learn: {
    id: 'learn',
    title: { en: 'Academy', es: 'Academia' },
    kicker: { en: 'Academy', es: 'Academia' },
    description: {
      en: 'Courses and guided labs together: learn the engine, practice the symptom, and keep moving in one place.',
      es: 'Cursos y labs guiados juntos: aprende el motor, practica el sintoma y avanza en un solo sitio.',
    },
    route: '/learn',
    icon: BookOpen,
...
export const SURFACE_GUIDES: Record<SurfaceId, SurfaceGuideDefinition> = {
  learn: {
    title: { en: 'Academy with labs included', es: 'Academia con labs integrados' },
    intro: {
      en: 'Start with the concept, then open the practical lab in the same path. Theory and practice live together here.',
      es: 'Empieza por el concepto y abre el lab practico en la misma ruta. Teoria y practica viven juntas aqui.',
    },
    coaching: {
      en: 'This academy is the main route: courses, play views, and DBA drills are part of the same progression.',
      es: 'Esta academia es la ruta principal: cursos, vistas play y drills DBA forman parte del mismo recorrido.',
    },
  ...
  learn: [
    {
      id: 'level-1',
      surface: 'learn',
      label: { en: 'Stage 1 - Engine fundamentals + first lab', es: 'Etapa 1 - Fundamentos del motor + primer lab' },
      description: {
        en: 'Start with how SQL Server is shaped, then practice the first incident drill without leaving the academy.',
        es: 'Empieza por como esta montado SQL Server y practica el primer drill de incidencia sin salir de la academia.',
      },
      goal: {
        en: 'Understand how architecture, storage, memory, execution, and the first DBA decision drill fit together.',
        es: 'Entiende como encajan arquitectura, almacenamiento, memoria, ejecucion y el primer drill de decision DBA.',
      },
      outcome: {
        en: 'You finish this stage with a clean model of how a query moves through the engine and how to read a symptom.',
        es: 'Cierras esta etapa con un modelo claro de como se mueve una query por el motor y como leer un sintoma.',
      },
    ...
    },
    {
      id: 'level-2',
      surface: 'learn',
      label: { en: 'Stage 2 - Performance, design, and operations', es: 'Etapa 2 - Rendimiento, diseno y operaciones' },
      description: {
        en: 'Move into indexes, schedulers, counters, host settings, and the job practices that keep the instance healthy.',
        es: 'Pasa a indices, schedulers, contadores, ajustes del host y practicas de jobs que mantienen sana la instancia.',
      },
      goal: {
        en: 'Learn why shape, counters, waits, configuration, and scheduled maintenance point to the same problem from different angles.',
        es: 'Aprende por que forma, contadores, waits, configuracion y mantenimiento programado apuntan al mismo problema desde angulos distintos.',
      },
      outcome: {
