...
export type ModuleId = 'architecture' | 'storage' | 'memory' | 'execution' | 'dba' | 'jobs' | 'ha' | 'indexes' | 'realcases' | 'osconfig' | 'perfmon' | 'sqlos' | 'modern' | 'tlog-internals' | 'tempdb-io' | 'replication' | 'version-history';
